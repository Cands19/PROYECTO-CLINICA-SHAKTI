...
<body>
      ...
      <!--imagen de fondo-->
<div class="imagenfondo"><img src="../assets/images/fotosclinica/fondoprintrabajado.jpg" width="2025" height="1000">
<br>  
 <br> 
   <h1>MÉDICOS</h1>
<br>
...
<contacto>
   ...
   <div class="colum11">
      ...
      <div class="row3">
         ...
         left; margin-bottom: 1em; margin-right:0em;" target="_blank"><img src="../assets/images/tefele.png" alt="Correo"></a>
   ...
   <div class="cont2">
      <div class="colum12">
         <h1>Escribenos</h1>
         <div class="row4">
            <a href="https://mail.google.com/mail/u/0/#inbox"><img src="../assets/images/correo.png" alt="Correo"></a>
      ...
      <div class="cont3">
         <div class="colum13">
            <h1>Visitanos</h1>
            <div class="row5">
               <a href="https://goo.gl/maps/7NoHsnE9FPsMqhuR7"><img src="../assets/images/ubi.png" alt="Ubicación"></a>
            <label>Av. Miguel Hidalgo Ote. 809, Barrio de San Bernardino, 50080 Toluca de Lerdo, Méx.</label>
   ...
   <br>
      ...
      <marquee bgcolor="#006699" behavior="alternate" direction="right">
          <b><font color="#FFFFCC" size="20">UBICACIÓN DE LA CLÍNICA "SHAKTI"</font></b>
         </marquee>
<br>  <br> <br>  <br>
      <div class="mapa">
         ...
         8!4f-0.694773386327384!5f0.4000000000000002" width="1750" height="850" 
         style="border: 10px;;" allowfullscreen="" loading="lazy"></iframe>   
</div>
   
  <br> 
   <br>
 <?php include('layout/formulario.php')?> <br>
